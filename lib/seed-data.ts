...
const rawEvents: Event[] = [
  ...
  makeEvent({ id: "south-africa-radio", headline: "Community radio archive opens to public", summary: "A digitized collection preserves four decades of local reporting, music and oral history from stations across the country.", category: "Culture and sports", primaryCountry: "ZA", affectedCountries: ["ZA"], scope: "National", ageHours: 44, scoring: { independentSourceCount: 3, sourceCountryCount: 2, affectedCountryCount: 1, countrySignificance: 38, publisherProminence: 62, articlesPerHour: 0.4 }, eventSources: [sources.guardian, sources.aljazeera] }),
