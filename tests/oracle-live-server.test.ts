    ...
    const jordan = mergeCountryFeed(
      "Jordan",
      {
        ...
        articles: [
          ...
          { ...article("air-jordan-army", publishedAt), title: "Air Jordan 4 gets a military-inspired palette" },
          { ...article("kerry-jordan", publishedAt), title: "Kerry Jordan named city election department director" },
          { ...article("jordan-trade", publishedAt), title: "Trade seminar reinforces commitment to Jordan and West Bank markets" },
        ],
      },
      undefined,
    );
